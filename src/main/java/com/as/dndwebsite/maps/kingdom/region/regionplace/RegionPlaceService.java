...
import com.as.dndwebsite.maps.kingdom.region.place.PlaceRepository;
...
import static com.as.dndwebsite.maps.kingdom.region.place.PlaceService.PLACE_NOT_FOUND_MSG;
...
public class RegionPlaceService implements IRegionPlaceService {
    ...
    public EntryDTO getRegionRelatedToPlace(String name) {
        return regionRepository.findAllByPlaces_Name(name).orElseThrow(() -> new NotFoundException(String.format(REGION_NOT_FOUND_MSG, name)));
    }
