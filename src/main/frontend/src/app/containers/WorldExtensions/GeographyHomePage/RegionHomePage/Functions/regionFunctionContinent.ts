...
import { ContinentRegionControllerService, EntryDTO, OpenAPI, RegionDTO } from "../../../../../../services/openapi";
...
export function RegionFunctionContinent(props: IRegionFunctionContinent) {
  ...
  return { setNewContinentToRegion, setExistingContinentToRegion, removeContinentFromRegionFunction };
}