...
import { EntryDTO, EntryFullDTO, OpenAPI, RegionPlaceControllerService } from "../../../../../../services/openapi";
...
export function PlaceFunctionDomObjects(props: IPlaceFunctionDomObjects) {
  ...
  return { setNewRegionToPlace, setExistingRegionToPlace, removeRegionFromPlaceFunction };
}