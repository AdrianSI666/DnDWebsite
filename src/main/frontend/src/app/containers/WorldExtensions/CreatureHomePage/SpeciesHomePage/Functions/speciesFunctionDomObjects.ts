...
import { CreatureTypeSpeciesControllerService, EntryDTO, OpenAPI, SpeciesDTO } from "../../../../../../services/openapi"
...
export function SpeciesFunctionDomObjects(props: ISpeciesFunctionDomObjects) {
    ...
    return { setNewCreatureTypeToSpecies, setExistingCreatureTypeToSpecies, removeCreatureTypeFromSpeciesFunction };
}
