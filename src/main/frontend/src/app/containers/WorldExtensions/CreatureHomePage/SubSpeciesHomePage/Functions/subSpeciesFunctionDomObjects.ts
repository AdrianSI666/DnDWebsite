...
import { EntryDTO, OpenAPI, SpeciesSubSpeciesControllerService, SubSpeciesDTO } from "../../../../../../services/openapi"
...
export function SubSpeciesFunctionDomObjects(props: ISubSpeciesFunctionDomObjects) {
    ...
    return { setNewSpeciesToSubSpecies, setExistingSpeciesToSubSpecies, removeSpeciesFromSubSpeciesFunction };
}
