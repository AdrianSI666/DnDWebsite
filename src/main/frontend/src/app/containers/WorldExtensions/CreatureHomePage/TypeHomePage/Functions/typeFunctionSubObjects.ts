...
import { CreatureTypeDTO, CreatureTypeSpeciesControllerService, EntryDTO, OpenAPI, PlaneCreatureTypeControllerService } from "../../../../../../services/openapi";
...
export function TypeFunctionSubObjects(props: ITypesubObjectsFunction) {
  ...
  return { saveNewSpeciesToType, saveExistingSpeciesToType, removeSpeciesFromTypeFunction, saveNewPlaneToCreatureType, saveExistingPlaneToCreatureType, removePlaneFromCreatureTypeFunction };
}