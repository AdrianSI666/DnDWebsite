...
import { EntryDTO, WorldControllerService, WorldPlaneControllerService, PlaneFullDTO, OpenAPI } from "../../../../services/openapi"
...
export function PlaneFunctionDomObjects(props: IPlaneFunctionDomObjects) {
    ...
    return { setNewWorldToPlane, setExistingWorldToPlane, getAllWorlds };
}
