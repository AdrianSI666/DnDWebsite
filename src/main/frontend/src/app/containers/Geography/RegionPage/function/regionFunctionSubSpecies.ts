...
import { EntryDTO, OpenAPI, RegionDTO, RegionSubSpeciesControllerService, SubSpeciesControllerService } from "../../../../../services/openapi";
...
export function RegionFunctionSubSpecies(props: IRegionFunctionSubSpecies) {
    ...
    const getAllSubSpecies = async () => {
        return await SubSpeciesControllerService.getAllSubSpecies()
            .catch((err) => {
