...
import { EntryDTO, KingdomControllerService, KingdomCountyControllerService, EntryFullDTO, OpenAPI } from "../../../../../services/openapi"
...
export function CountyFunctionDomObjects(props: ICountyFunctionDomObjects) {
    ...
    return { setNewKingdomToCounty, setExistingKingdomToCounty, removeKingdomFromCountyFunction, getAllKingdoms };
}
