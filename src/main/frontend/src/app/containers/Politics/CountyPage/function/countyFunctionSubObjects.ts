...
import { EntryDTO, EntryFullDTO, CountyRegionControllerService, OpenAPI } from "../../../../../services/openapi";
...
export function CountyFunctionSubObjects(props: ICountyFunctionSubObjects) {
  ...
  const getAllRegionsWithoutCounty = async () => {
    return await CountyRegionControllerService.getAllRegionsWithoutCounty()
      .catch((err) => {
