...
export class WorldCountyControllerService {
    /**
     * @param worldId
     * @param requestBody
     * @returns EntryDTO OK
     * @throws ApiError
     */
    public static addNewCountyWorldRelation(
        worldId: number,
        requestBody: EntryDTO,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/{worldId}/county',
            path: {
                'worldId': worldId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static addWorldCountyRelation(
        worldId: number,
        countyId: number,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/{worldId}/county/{countyId}',
            path: {
                'worldId': worldId,
                'countyId': countyId,
            },
     ...
     * @throws ApiError
     */
    public static addNewWorldCountyRelation(
        countyId: number,
        requestBody: EntryDTO,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/county/{countyId}',
            path: {
                'countyId': countyId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static getWorldRelatedToCounty(
        name: string,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/worlds/county/{name}',
            path: {
                'name': name,
            },
        });
