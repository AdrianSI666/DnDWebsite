...
export class WorldKingdomControllerService {
    /**
     * @param worldId
     * @param requestBody
     * @returns EntryDTO OK
     * @throws ApiError
     */
    public static addNewKingdomWorldRelation(
        worldId: number,
        requestBody: EntryDTO,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/{worldId}/kingdom',
            path: {
                'worldId': worldId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static addWorldKingdomRelation(
        worldId: number,
        kingdomId: number,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/{worldId}/kingdom/{kingdomId}',
            path: {
                'worldId': worldId,
                'kingdomId': kingdomId,
            },
     ...
     * @throws ApiError
     */
    public static addNewWorldKingdomRelation(
        kingdomId: number,
        requestBody: EntryDTO,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/kingdom/{kingdomId}',
            path: {
                'kingdomId': kingdomId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static getWorldRelatedToKingdom(
        name: string,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/worlds/kingdom/{name}',
            path: {
                'name': name,
            },
        });
