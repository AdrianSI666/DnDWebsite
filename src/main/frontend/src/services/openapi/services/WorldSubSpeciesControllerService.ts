...
export class WorldSubSpeciesControllerService {
    /**
     * @param worldId
     * @param requestBody
     * @returns EntryDTO OK
     * @throws ApiError
     */
    public static addNewSubSpeciesWorldRelation(
        worldId: number,
        requestBody: EntryDTO,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/{worldId}/subSpecies',
            path: {
                'worldId': worldId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static addWorldSubSpeciesRelation(
        worldId: number,
        subSpeciesId: number,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/{worldId}/subSpecies/{subSpeciesId}',
            path: {
                'worldId': worldId,
     ...
     * @throws ApiError
     */
    public static addNewWorldSubSpeciesRelation(
        subSpeciesId: number,
        requestBody: EntryDTO,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/worlds/subSpecies/{subSpeciesId}',
            path: {
                'subSpeciesId': subSpeciesId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static getWorldRelatedToSubSpecies(
        name: string,
    ): CancelablePromise<EntryDTO> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/worlds/subSpecies/{name}',
            path: {
                'name': name,
            },
        });
